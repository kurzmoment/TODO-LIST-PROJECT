...
class ActivityThisWeekShow extends StatefulWidget {
  final QuerySnapshot snapshot;
  final int index;

  const ActivityThisWeekShow({Key key, this.snapshot, this.index})
      : super(key: key);

  @override
  _ActivityThisWeekShowState createState() => _ActivityThisWeekShowState();
}

class _ActivityThisWeekShowState extends State<ActivityThisWeekShow> {
