...
class _ActivityTodayShowState extends State<ActivityTodayShow> {
  ...
  Widget build(BuildContext context) {
                                    ...
                                    child: ListView(
                                      ...
                                      children: [
                                        ...
                                        colorSwitch(Colors.lightBlue,
                                            'lightBlue', colorInputController),
                                        colorSwitch(Colors.lightGreen,
                                            'lightGreen', colorInputController),
              ...
              child: ListTile(
                ...
                trailing: IconButton(
                  ...
                  onPressed: () async {
                    ...
                    var newCollection =
                        FirebaseFirestore.instance.collection('userData');
                    newCollection.doc(uid).collection('categoryPoints').add({
                      'ikona': iconInputController.text,
                      'categoryName': iconInputController.text,
                      'point': point
                    });
                  },
                ),
    ...
    } else if (selectedDate.isAtSameMomentAs(formatedDate)) {
      return ListView(
        shrinkWrap: true,
        children: [
          Text(
