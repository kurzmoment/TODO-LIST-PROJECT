...
class ActivityFutureShow extends StatefulWidget {
  final QuerySnapshot snapshot;
  final int index;

  const ActivityFutureShow({Key key, this.snapshot, this.index})
      : super(key: key);

  @override
  _ActivityFutureShowState createState() => _ActivityFutureShowState();
}

class _ActivityFutureShowState extends State<ActivityFutureShow> {
  ...
  Widget build(BuildContext context) {
    ...
    if (selectedDate.isAfter(formattedThisWeek)) {
      return Slidable(
