...
class ActivityDoneShow extends StatefulWidget {
  ...
  @override
  _ActivityDoneShowState createState() => _ActivityDoneShowState();
}

class _ActivityDoneShowState extends State<ActivityDoneShow> {
                    ...
                    if (iconInputController.text == cat1) {
                      ...
                      if (cr.exists) {
                        ...
                        await collectionReference
                            ...
                            .doc(cat1)
                            .set(
                                {'name': iconInputController.text, 'point': 1});
                      }
                    }
                    // CAT 2
